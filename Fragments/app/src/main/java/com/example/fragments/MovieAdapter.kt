    ...
    fun generateMovie(): List<Movie> {
        return listOf(
            ...
            Movie(
                ...
                "https://avatars.mds.yandex.net/get-afishanew/29022/cd583b028ed14390877c610054d9c023/s190x280",
                "Элли и её верный пес Тотошка снова оказываются в Волшебной стране в самое подходящее время. Власть в Изумрудном городе опять пытается захватить коварный Урфин Джюс, который хоть и потерял армию деревянных солдат, но не отказался от своей вредной привычки — портить всем жизнь. В руках Урфина теперь волшебная книга колдуньи Гингемы, которая исполняет любое желание её хозяина, а значит, Страшила Мудрый, Храбрый Лев и Железный Дровосек в опасности. Элли, Тотошка и их новый приятель Тим решают помочь жителям Волшебной страны. Тем более, Тиму нравится Элли, а что не сделаешь ради любви? Например, глупость. Но ошибки совершает каждый, а вот исправлять их умеют немногие."
            ),
            Movie(
                "Текст",
                "https://avatars.mds.yandex.net/get-afishanew/29022/a65e5cae802ac1691cc3e543b066aee7/s190x280",
                "Главный герой — 27-летний Илья Горюнов, семь лет отсидевший в тюрьме по ложному обвинению в распространении наркотиков. Когда Илья выходит на свободу, он понимает, что прежняя жизнь, по которой он тосковал, разрушена, и вернуться к ней он больше не сможет. Хотя он не собирался мстить человеку, который "
            ),
            Movie(
                "Zомбилэнд: Контрольный выстрел",
                "https://avatars.mds.yandex.net/get-afishanew/36842/81990e58db8c3222c0f3c4016d985fa3/s190x280",
                "Беспощадная и бесстрашная четвёрка охотников на зомби продолжает своё путешествие в глубь страны. На этот раз им предстоит сразиться не только с новыми видами живых мертвецов, но и вступить в схватку с другими выжившими, которые настроены совсем не дружелюбно. Кроме того, в собственных рядах охотников намечается "
            )
        )
    }
